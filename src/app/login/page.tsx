...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (res?.error) {
      // NextAuth usa el código genérico "CredentialsSignin" cuando el
      // usuario o la contraseña no coinciden (para no filtrar si el correo
      // existe); cualquier otro mensaje (p. ej. límite de intentos) viene
      // literal y se puede mostrar tal cual.
      setError(
